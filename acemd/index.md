...
<a href="http://download.acellera.com/manuals/latest/docs/ACEMD-AceCloud-User-Guide.pdf" target="_parent"><strong>ACEMD Plugin Development (pdf)<strong></a>. This is an advanced guide to write C extensions for ACEMD using a call-back interface. 
